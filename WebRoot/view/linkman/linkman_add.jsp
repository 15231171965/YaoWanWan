...
.auto-style1 {
	...
	<body>
		<form action="LinkManAddServlet2" method="post" name="form1" onsubmit="return checkForm('form1');">
			<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<select name="CustomerName" style="width: 145px">
							...
							%>
							<option value="<%=sourceInfo.getCustomer_id()%>"><%=sourceInfo.getCustomer_name()%></option>
			...
			<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
				...
				<tr bgcolor="#ECF3FD">
					<td width="25%"></td>
					<td width="17%"><input type="button" name="button"  onClick="history.back() "  value="返回"></td>
					<td width="17%"><input type="reset" name="reset"  value="重置"></td>
					<td width="4%"><input type="submit"   value="添加"></td>
					<td width="43%"></td>
				</tr>
			</table>
